...
El objetivo de este ejercicio es implementar parcialmente el modelo del juego [bombermanGame.bombermanGame][2] siguiendo los criterios listados en la sección Objetivos.
